...
Crossinline
Refied
Where - Implementation is remaining

Coroutine 
----------
Async
Launch
How to call API in parallel and sequentially
Coroutine Cancellation - Implementation is remaining
withContext
RunBlocking
...
You need a wallabag account first, which you are going to use in this app.
